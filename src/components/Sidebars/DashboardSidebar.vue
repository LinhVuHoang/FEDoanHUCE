<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<div class="brand"><img src="/images/HUCE_DHXD_Logo.png" alt=""> <span>HUCE Dashboard</span></div>
			<hr>

			<!-- Sidebar Navigation Menu -->
			<a-menu theme="light" mode="inline" v-if="this.checkrole==1">
				<a-menu-item>

					<router-link to="/QLTaiKhoan">
						<span class="icon">
							<svg fill="#000000"  width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                <g id="SVGRepo_iconCarrier"><title>Account Settings</title>
...
<!--							</svg>-->
<!--						</span>-->
<!--						<span class="label">Lịch thi</span>-->
<!--					</router-link>-->
<!--				</a-menu-item>-->
<!--				<a-menu-item>-->
<!--					<router-link to="/DSDangKyHocPhan">-->
<!--						<span class="icon">-->
<!--							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">-->
<!--								<path d="M531.7 588.3V162.8C531.7 104.8 587.7 56 655.9 56c8.3 0 16.7 0.2 25 0.7 40 2.3 81.3 33.8 81.3 96v425.4c32.6 13.7 58.7 45 58.7 81.7v327.8c0 66-54.5 120.2-121.7 120.2H224.1c-67.3 0-121.8-54.2-121.8-120.2v-327.8c0-36.6 26.1-68 58.7-81.7zM237 99.2c-33.7 0-61.7 27.3-61.7 63.6v327.8c0 43 34.5 79.6 77.9 79.6h635.6c43.4 0 77.9-36.6 77.9-79.6v-327.8c0-36.3-28-63.6-61.7-63.6H237z" fill="#111827"></path>-->
...
<!--						</span>-->
<!--						<span class="label">Đăng Ký Học Phần SV</span>-->
<!--					</router-link>-->
<!--				</a-menu-item>-->
<!--        <a-menu-item>-->
<!--          <router-link to="/DS_LHP_SiSo">-->
<!--						<span class="icon">-->
<!--							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">-->
...
<!--							</svg>-->
<!--						</span>-->
<!--            <span class="label">Danh sách lớp học phần</span>-->
<!--          </router-link>-->
<!--        </a-menu-item>-->
<!--        <a-menu-item>-->
<!--          <router-link to="/KetQuaHocTap">-->
<!--            <span class="icon">-->
<!--              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">-->
...
<!--              </svg>-->
<!--            </span>-->
<!--            <span class="label">Kết quả học tập</span>-->
<!--          </router-link>-->
<!--        </a-menu-item>-->
<!--        <a-menu-item>-->
<!--          <router-link to="/TKBGiangDay">-->
<!--            <span class="icon">-->
<!--             <svg fill="#000000" width="20px" height="20px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>alt-center-align</title> <path d="M0 26.016q0 2.496 1.76 4.224t4.256 1.76h20q2.464 0 4.224-1.76t1.76-4.224v-20q0-2.496-1.76-4.256t-4.224-1.76h-20q-2.496 0-4.256 1.76t-1.76 4.256v20zM4 26.016v-20q0-0.832 0.576-1.408t1.44-0.608h20q0.8 0 1.408 0.608t0.576 1.408v20q0 0.832-0.576 1.408t-1.408 0.576h-20q-0.832 0-1.44-0.576t-0.576-1.408zM8 10.016h16v-2.016h-16v2.016zM10.016 18.016h12v-2.016h-12v2.016zM12 14.016h8v-2.016h-8v2.016zM14.016 22.016h4v-2.016h-4v2.016z"></path> </g></svg>-->
<!--            </span>-->
<!--            <span class="label">TKB Giảng Dạy</span>-->
<!--          </router-link>-->
<!--        </a-menu-item>-->
<!--        <a-menu-item>-->
<!--          <router-link to="/LichSuPH">-->
<!--            <span class="icon">-->
...
<!--							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">-->
<!--								<path xmlns="http://www.w3.org/2000/svg" d="M3 9H21M3 15H21M9 9L9 20M15 9L15 20M6.2 20H17.8C18.9201 20 19.4802 20 19.908 19.782C20.2843 19.5903 20.5903 19.2843 20.782 18.908C21 18.4802 21 17.9201 21 16.8V7.2C21 6.0799 21 5.51984 20.782 5.09202C20.5903 4.71569 20.2843 4.40973 19.908 4.21799C19.4802 4 18.9201 4 17.8 4H6.2C5.0799 4 4.51984 4 4.09202 4.21799C3.71569 4.40973 3.40973 4.71569 3.21799 5.09202C3 5.51984 3 6.07989 3 7.2V16.8C3 17.9201 3 18.4802 3.21799 18.908C3.40973 19.2843 3.71569 19.5903 4.09202 19.782C4.51984 20 5.07989 20 6.2 20Z" fill="#111827" />-->
<!--							</svg>-->
<!--						</span>-->
<!--          <span slot="title" class="label" style="color: black">OKE</span>-->
<!--          <a-menu-item key="tkb">-->
<!--            <router-link to="/TKBHocKy">-->
...
<!--				</a-menu-item>-->
    ...
    <a-menu theme="light" mode="inline" v-if="this.checkrole==2">
      <a-menu-item>
        <router-link to="/TKBHocKy">
						<span class="icon">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a-menu theme="light" mode="inline" v-if="this.checkrole==3">
      <a-menu-item>
        <router-link to="/TKBGiangDay">
            <span class="icon">
             <svg fill="#000000" width="20px" height="20px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>alt-center-align</title> <path d="M0 26.016q0 2.496 1.76 4.224t4.256 1.76h20q2.464 0 4.224-1.76t1.76-4.224v-20q0-2.496-1.76-4.256t-4.224-1.76h-20q-2.496 0-4.256 1.76t-1.76 4.256v20zM4 26.016v-20q0-0.832 0.576-1.408t1.44-0.608h20q0.8 0 1.408 0.608t0.576 1.408v20q0 0.832-0.576 1.408t-1.408 0.576h-20q-0.832 0-1.44-0.576t-0.576-1.408zM8 10.016h16v-2.016h-16v2.016zM10.016 18.016h12v-2.016h-12v2.016zM12 14.016h8v-2.016h-8v2.016zM14.016 22.016h4v-2.016h-4v2.016z"></path> </g></svg>
